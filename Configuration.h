...
#define STRING_CONFIG_H_AUTHOR "(andrea)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200, 200, 1600, 415 }
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT2_INVERTING true // set to true to invert the logic of the sensor.
  #define FIL_RUNOUT2_PULLUP          // Use internal pullup for filament runout pins.
  #define FILAMENT_RUNOUT2_SCRIPT "M600"
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 5), (Y_MIN_POS + 25), 20 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { -20, 30, (Z_MIN_POS + 1)}
  #define NOZZLE_CLEAN_END_POINT   { -20, 40, (Z_MIN_POS + 1) }
